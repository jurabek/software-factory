...
5. Reviewers report blocking findings without changing product code.
6. Testers execute every required repository check locally.
7. Blocking review or failed checks enter a bounded repair loop.
8. Successful local testing completes the Campaign as
   `implementation_complete`.
9. Campaign input, results, checks, findings, sessions, and events are stored
...
- Planner, Reviewer, and Tester do not modify product code.
